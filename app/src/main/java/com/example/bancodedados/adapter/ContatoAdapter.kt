...
class ContatoAdapter(private val context: Context, private val listaUsuarios: MutableList<Usuario>):
    ...
    override fun onBindViewHolder(holder: ContatoViewHolder, position: Int) {
        ...
        holder.txtPeso.text   = listaUsuarios[position].peso
        holder.txtAltura.text   = listaUsuarios[position].altura
        holder.txtImc.text   = listaUsuarios[position].imc
        ...
        holder.btAtualizar.setOnClickListener{
            ...
            intent.putExtra("imc",   listaUsuarios[position].imc)
